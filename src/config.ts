...
export const siteConfig: SiteConfig = {
	...
	siteStartDate: "2026-02-25", // 站点开始运行日期，用于站点统计组件计算运行天数
	...
	links: [
		...
		// 支持自定义导航栏链接，支持多级菜单
		{
			...
			children: [
				{
					name: "GitHub",
					url: "hhttps://github.com/unravel-xu/blog",
					external: true,
...
export const profileConfig: ProfileConfig = {
	avatar: "/images/avatar.jpg", // 相对于 /src 目录。如果以 '/' 开头，则相对于 /public 目录
	name: "Evariste-Xu",
	bio: "我是自己的千军万马",
	typewriter: {
